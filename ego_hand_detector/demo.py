...
# CUDA_VISIBLE_DEVICES=0 python demo.py --cuda 1 --checkepoch=8 --checkpoint=132028 --p 0:1
    ...
    for video_name, frames in todo_list:
      ...
      for frame in [0]:
        ...
        if vis:
          ...
          result_path = os.path.join(folder_name, file_name + "_det.png")
